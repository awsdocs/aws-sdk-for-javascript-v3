...
## Endpoint String Format<a name="w4aac12c19b5"></a>

Endpoint values should be a string in the format:

**`https://{service}.{region}.amazonaws.com`**

## Endpoints for the ap\-northeast\-3 Region<a name="w4aac12c19c11"></a>
...
## Endpoints for MediaConvert<a name="w4aac12c19c13"></a>
...
var mcClient = new MediaConvert({endpoint: 'https://abcd1234.mediaconvert.us-west-1.amazonaws.com'});
